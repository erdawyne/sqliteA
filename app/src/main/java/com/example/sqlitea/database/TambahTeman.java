...
public class TambahTeman extends AppCompatActivity {
    ...
    private static String url_insert = "https://20200140039.praktikumtiumy.com/tambahtm.php";
    ...
    public void SimpanData()
    {
        if(editNama.getText().toString().equals("") || editTelpon.getText().toString().equals("")){
            Toast.makeText(TambahTeman.this,"Semua Harus di isi data",Toast.LENGTH_SHORT).show();
        }
        else
        {
